...
function resolveTargets(targets) {
  ...
  // If both groupId and lightIds exist, prefer lightIds by default.
  // Group targeting can still be forced by explicitly passing targets.groupId.
  const hasExplicitGroupId = Object.prototype.hasOwnProperty.call(t, "groupId");
  const groupId = hasExplicitGroupId
    ? t.groupId != null
      ? Number(t.groupId)
      : undefined
    : Array.isArray(lightIds) && lightIds.length > 0
      ? undefined
      : base.groupId;
